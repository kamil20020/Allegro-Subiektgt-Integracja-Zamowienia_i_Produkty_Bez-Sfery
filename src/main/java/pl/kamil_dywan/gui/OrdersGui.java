...
public class OrdersGui implements ChangeableGui {
    ...
    private JScrollPane ordersTableScroll;
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        ordersTableScroll = new JScrollPane();
        ordersTableScroll.setOpaque(true);
        ...
        gbc.insets = new Insets(25, 50, 50, 50);
        mainPanel.add(ordersTableScroll, gbc);
        ordersTableScroll.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEmptyBorder(), null, TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
