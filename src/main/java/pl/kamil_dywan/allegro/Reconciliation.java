...
public class Reconciliation {
    ...
    public String toString() {
        ...
        sb.append(Reconciliation.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("amount");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Reconciliation) == false) {
            return false;
        }
        Reconciliation rhs = ((Reconciliation) other);
