...
public class Marketplace {
    ...
    public String toString() {
        ...
        sb.append(Marketplace.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Marketplace) == false) {
            return false;
        }
        Marketplace rhs = ((Marketplace) other);
