...
public class Guaranteed {
    ...
    public String toString() {
        ...
        sb.append(Guaranteed.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("from");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Guaranteed) == false) {
            return false;
        }
        Guaranteed rhs = ((Guaranteed) other);
