...
public class TotalToPay {
    ...
    public String toString() {
        ...
        sb.append(TotalToPay.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("amount");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TotalToPay) == false) {
            return false;
        }
        TotalToPay rhs = ((TotalToPay) other);
